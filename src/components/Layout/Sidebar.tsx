      ...
      {({ isActive }) => (
        <div
          className={`flex items-center justify-between px-4 py-3 rounded-xl transition-all duration-200 ${
            isActive
              ? 'bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-900 font-semibold shadow-sm border border-blue-100'
              : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900 font-medium'
          }`}
        >
          <div className="flex items-center space-x-3">
            <div className={`w-5 h-5 flex items-center justify-center ${isActive ? 'text-blue-600' : 'text-gray-500'}`}>
              {icon}
            </div>
