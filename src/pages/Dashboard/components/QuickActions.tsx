import { AlertTriangle, Barcode, FileText, Plus, ShoppingCart, UserPlus } from 'lucide-react';
...
const QuickActionButton: React.FC<QuickActionButtonProps> = ({
  ...
  return (
    <button
      onClick={onClick}
      className="flex flex-col items-center justify-center p-6 bg-white rounded-lg border border-gray-200 hover:border-gray-300 shadow-sm hover:shadow-md transition-all group"
    >
      <div
